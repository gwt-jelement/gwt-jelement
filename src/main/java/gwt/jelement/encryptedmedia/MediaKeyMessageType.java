...
public enum MediaKeyMessageType{
    ...
    MediaKeyMessageType(String internalValue){
    ...
    public static MediaKeyMessageType of(String value){
        switch(value){
    ...
    public static MediaKeyMessageType[] ofArray(String[] values) {
        return Arrays.<String>stream(values)
                .map(MediaKeyMessageType::of)
                .toArray(MediaKeyMessageType[]::new);
    }
