...
@JsType(namespace = JsPackage.GLOBAL, name="Uint32Array", isNative = true)
public class Uint32Array extends ArrayBufferView implements ArrayLike<Double> {
    ...
    @JsMethod(name = "set")
    public native void set(Uint32Array array, double offset);
    ...
    public native Uint32Array subarray(double begin);
    
    @JsMethod(name = "subarray")
    public native Uint32Array subarray(double begin, double end);
