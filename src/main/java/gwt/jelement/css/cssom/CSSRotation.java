...
public class CSSRotation extends CSSTransformComponent{
    ...
    @JsConstructor
    public CSSRotation(double x, double y, double z, CSSNumericValue angle){
        super();
    }
    
    @JsProperty(name="angle")
    public native CSSNumericValue getAngle();
    
    @JsProperty(name="angle")
    public native void setAngle(CSSNumericValue angle);
