...
public class Range{
    ...
    public native short comparePoint(Node node, long offset);
    ...
    public native boolean isPointInRange(Node node, long offset);
    ...
    public native void setEnd(Node node, long offset);
    ...
    public native void setStart(Node node, long offset);
